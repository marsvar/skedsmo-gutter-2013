    ...
    >
      ...
      <div className="flex items-center justify-between px-4 pt-3.5 pb-2">
        <div className="flex items-baseline gap-1.5">
          <span
            className="font-heading font-semibold text-[11px] tracking-widest"
            style={{ color: '#6b7280' }}
          >
            {dayName}
          </span>
      ...
      <div className="px-4 pb-3.5">
        ...
        <div
          className="font-heading font-semibold text-xs tracking-widest my-1"
          style={{ color: '#4b5563' }}
        >
  ...
  return (
    ...
    >
      ...
      <div className="text-center w-9 shrink-0">
        ...
        <div
          className="font-heading font-semibold text-[10px] tracking-wider mt-0.5"
          style={{ color: '#6b7280' }}
        >
          {month}
        </div>
      ...
      <div className="flex-1 min-w-0">
        <div
          className="font-heading font-bold text-sm uppercase truncate"
        ...
        {match.result && (
          <div
            className="font-heading font-extrabold text-xl leading-none mt-0.5"
            style={{ color: '#e5e7eb' }}
          >
...
const allMatchesSorted = getAllMatches()
...
export default function MatchesPage() {
  ...
  const filtered = useMemo(
    () => allMatchesSorted.filter((m) => matchBelongsTo(m, filter)),
    [filter],
  )
    ...
    <div className="min-h-screen pb-28" style={{ background: '#0b0b0b' }}>
      ...
      <div className="px-4 pt-8 pb-5">
        <div className="flex items-end gap-3 mb-1">
          ...
          <div
            className="mb-1 w-1.5 h-6 rounded-full"
            style={{ background: '#c6180e' }}
          />
        </div>
        <p
          ...
          style={{ color: '#6b7280' }}
        >
          G13 · Sesong 2026 · {allMatchesSorted.length} kamper
        </p>
      </div>
        ...
        <div className="px-4 mb-5 grid grid-cols-4 gap-2">
          {[
            ...
            >
              ...
              <div
                className="font-heading font-semibold text-[11px] tracking-wide mt-0.5"
                style={{ color: '#6b7280' }}
              >
                {label}
              </div>
      ...
      {upcoming.length > 0 && (
        <section className="px-4 mb-7">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-heading font-bold text-xs" style={{ color: '#4b5563' }}>
              {upcoming.length}
            </span>
          </div>
        ...
        <section className="px-4 mb-7">
          ...
          {past.length > 3 && (
            ...
            >
              {showAllPast
                ? 'Vis færre'
                : `Vis alle ${past.length} spilte kamper`}
            </button>
          )}
        </section>
      )}
      ...
      {filtered.length === 0 && (
        <div className="px-4 py-20 text-center">
          ...
          <p
            className="font-heading font-bold text-base uppercase tracking-wide mt-4"
            style={{ color: '#6b7280' }}
          >
            Ingen kamper
          </p>
